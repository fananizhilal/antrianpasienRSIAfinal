<!-- Modal -->
<div wire:ignore.self class="modal fade" id="editAntrian" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      ...
      <div class="modal-content">
        ...
        <form wire:submit.prevent="updateAntrian">
            ...
            <div class="mb-3">
                ...
                <input type="text" wire:model="no_hp" class="form-control" readonly>
                @error('no_hp') <span class="text-danger">{{ $message }}</span> @enderror
            </div> 
            <div class="mb-3">
                <label>Nomor KTP</label>
                <input type="text" wire:model="no_ktp" class="form-control" readonly>
