...
<head>
  ...
  <title>Dashboard - Antrian Online Rumah Sakit Ibu dan Anak</title>
...
<body>
  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="/dashboard" class="logo d-flex align-items-center">
        <span class="d-none d-lg-block">Antrian Online RSIA</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="/dashboard/antrian/poliAnak">
              <i class="bi bi-circle"></i><span>Poli Anak</span>
            </a>
          </li>
          <li>
            <a href="/dashboard/antrian/poliKandungan">
              <i class="bi bi-circle"></i><span>Poli Kandungan</span>
            </a>
          </li>
          <li>
            <a href="/dashboard/antrian/poliNeonatologi">
              <i class="bi bi-circle"></i><span>Poli Neonatologi</span>
            </a>
          </li>
        </ul>
  ...
  <footer id="footer" class="footer">
    <div class="copyright">
      &copy; Copyright <strong><span>Rumah Sakit Ibu dan Anak</span></strong>. All Rights Reserved
    </div>
    <div class="credits">
      ...
      Designed by <a href="https://bootstrapmade.com/">Rumah Sakit Ibu dan Anak</a>
    </div>
  </footer><!-- End Footer -->
