...
class DashboardPoliNeonatologi extends Component
{
    use WithPagination;
    ...
    {
        return view('livewire.daftarpoli.dashboard-poli-neonatologi',[
            'poliNeonatologi' => Antrian::where('poli', 'neonatologi')->where('is_call', 0)->paginate(10)
        ]);
    }
}
